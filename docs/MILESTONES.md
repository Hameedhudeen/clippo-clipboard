...
| --- | --- | --- |
| `v0.1` | Repository scaffold | Workspace builds locally, docs exist, and open-source project positioning is present. |
...
| `v0.5` | Workflow parity | Core Clippo workflows are implemented or documented as OS-specific differences. |
...
- Workflow parity issues must link to `docs/PARITY.md`.
